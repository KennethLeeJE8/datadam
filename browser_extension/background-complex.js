  ...
  async connect() {
    ...
    this.mcpProcess = new Promise((resolve, reject) => {
      ...
      if (typeof chrome !== 'undefined' && chrome.runtime) {
        // Browser extension environment - use native messaging instead
        reject(new Error('Browser extension cannot spawn processes directly. Use native messaging or external server.'));
        return;
      }
